...
#| label: fig-mylabel
#| fig-cap: Density plots that shows the distribution of contacts within each type of edgelists (2018). Topcoded at 20 contacts.
knitr::include_graphics('img/dst-shot/fig-edgelist-type-ridgeplot1.png')
```
