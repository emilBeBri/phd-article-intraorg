...
plot_ab1[term == 'mgnr female tie * female']
...
plot_ab2a = plot_ab1[( term %ilike% '^female$' | term %ilike% 'non-mgnr.*' )   & grp %ilike% 'noman|all']
...
plot_ab2b = plot_ab1[( term %ilike% '^female$' | term %ilike% '^mgnr.*' )   & grp %ilike% '^man|all']
# make a coef plot with conf intervals in ggplot and x axis should have 0.025 as tick marks
